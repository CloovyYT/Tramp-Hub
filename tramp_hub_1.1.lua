...
close.Position = UDim2.new(0.947826087, 0, 0.0073529412, 0)
close.Size = UDim2.new(0, 24, 0, 29)
...
close_2.Position = UDim2.new(0.867391169, 0, 0, 0)
close_2.Size = UDim2.new(0, 60, 0, 51)
...
close_3.Name = "close"
close_3.Parent = creds
close_3.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
close_3.BackgroundTransparency = 1.000
close_3.Position = UDim2.new(0.932608724, 0, 0.0147058824, 0)
close_3.Size = UDim2.new(0, 31, 0, 30)
...
open.Position = UDim2.new(-0.00121506688, 0, 0.80119282, 0)
open.Size = UDim2.new(0, 100, 0, 100)
open.Visible = false
open.Image = "http://www.roblox.com/asset/?id=7288021208"

-- Scripts:

local function IMNH_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(IMNH_fake_script)()
local function ICEVA_fake_script() -- close.LocalScript 
	local script = Instance.new('LocalScript', close)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Parent.Parent.Parent.Visible = false
		script.Parent.Parent.Parent.Parent.Parent.Parent.open.Visible = true
	end)
end
coroutine.wrap(ICEVA_fake_script)()
local function SXMKNBU_fake_script() -- admin.Script 
...
coroutine.wrap(SXMKNBU_fake_script)()
local function SRYHW_fake_script() -- da.Script 
...
coroutine.wrap(SRYHW_fake_script)()
local function TUZE_fake_script() -- da2.Script 
...
coroutine.wrap(TUZE_fake_script)()
local function FNTT_fake_script() -- admin2.Script 
...
coroutine.wrap(FNTT_fake_script)()
local function MLUC_fake_script() -- anim.Script 
...
coroutine.wrap(MLUC_fake_script)()
local function TZLQKAS_fake_script() -- sa.Script 
...
coroutine.wrap(TZLQKAS_fake_script)()
local function HPQYYC_fake_script() -- close_2.LocalScript 
...
coroutine.wrap(HPQYYC_fake_script)()
local function KZFTUHH_fake_script() -- close_3.LocalScript 
...
coroutine.wrap(KZFTUHH_fake_script)()
local function COMVQC_fake_script() -- hub_2.LocalScript 
...
coroutine.wrap(COMVQC_fake_script)()
local function LHZD_fake_script() -- cred.LocalScript 
...
coroutine.wrap(LHZD_fake_script)()
local function PFOYYA_fake_script() -- hakdrag.Dragify 
...
coroutine.wrap(PFOYYA_fake_script)()
local function AZQKGYP_fake_script() -- open.LocalScript 
	local script = Instance.new('LocalScript', open)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.hakdrag.Visible = true
		script.Parent.Visible = false
	end)
end
coroutine.wrap(AZQKGYP_fake_script)()
